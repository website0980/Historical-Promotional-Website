...
<div class="form-group">
    <?php if (!empty($image)): ?>
        <img src="<?php echo htmlspecialchars($image); ?>" style="max-width:200px; border-radius:8px;">
        <p>Current: <?php echo basename($image); ?></p>
        <button type="button" class="btn btn-primary" onclick="document.getElementById('image-file').click();">Change Image</button>
    <?php else: ?>
        <button type="button" class="btn btn-primary" onclick="document.getElementById('image-file').click();">Upload Image</button>
    <?php endif; ?>
    ...
    <small>Select to change - uploads on Save</small>
</div>
