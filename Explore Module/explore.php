    ...
    <section class="explore-full-page">
        <div class="explore-container">
            ...
            <div class="section-content active" id="featured">
                ...
                <img src="../assets/images/featured.jpg" alt="Featured Destinations" class="section-image">
            ...
            <div class="section-content" id="natural-wonders">
                ...
                <img src="../assets/images/natural-wonders.jpg" alt="Natural Wonders" class="section-image">
                <div class="content-text">
            ...
            <div class="section-content" id="cultural-sites">
                ...
                <img src="../assets/images/cultural-sites.jpg" alt="Cultural Sites" class="section-image">
                <div class="content-text">
            ...
            <div class="section-content" id="local-cuisine">
                <h1>Local Cuisine</h1>
                <img src="../assets/images/local-cuisine.jpg" alt="Local Cuisine" class="section-image">
                <div class="content-text">
...
<div class="cuisine-grid">
            ...
            <div class="section-content" id="festivals">
                <h1>Festivals</h1>
                <img src="../assets/images/festivals.jpg" alt="Festivals" class="section-image">
                <div class="content-text">
